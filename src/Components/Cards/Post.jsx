...
// import { addComment, likePost, unlikePost } from "../../lib/controller";
...
//     try {
//       if (liked) {
//         await unlikePost(post.id); // Giảm số lượng like
//         setLikeCount(likeCount - 1);
//       } else {
//         await likePost(post.id); // Tăng số lượng like
//         setLikeCount(likeCount + 1);
//       }
//       setLiked(!liked);
//     } catch (error) {
...
//       author: "User ID", // Thay thế bằng ID hoặc tên người dùng thực
